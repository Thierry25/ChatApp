...
public class ForwardMessageAdapter extends RecyclerView.Adapter<ForwardMessageAdapter.UsersViewHolder> {
    ...
    public ForwardMessageAdapter(List<Users> usersStored) {
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                if (isThere[0]) {
                                                    ...
                                                    messageMap.put("type", user.getType());
