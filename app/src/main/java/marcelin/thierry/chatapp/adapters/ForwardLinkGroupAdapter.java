...
public class ForwardLinkGroupAdapter extends RecyclerView.Adapter<ForwardLinkGroupAdapter.UsersViewHolder> {
    ...
    public ForwardLinkGroupAdapter(List<Users> usersStored) {
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                if (isThere[0]) {
                                                    ...
                                                    messageMap.put("type", "group_link");
