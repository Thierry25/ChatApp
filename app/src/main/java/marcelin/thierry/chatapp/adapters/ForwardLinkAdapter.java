...
public class ForwardLinkAdapter extends RecyclerView.Adapter<ForwardLinkAdapter.UsersViewHolder> {
    ...
    public ForwardLinkAdapter(List<Users> usersStored) {
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                if (isThere[0]) {
                                                    ...
                                                    messageMap.put("type", "channel_link");
