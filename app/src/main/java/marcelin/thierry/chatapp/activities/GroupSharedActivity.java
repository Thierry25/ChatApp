...
import marcelin.thierry.chatapp.adapters.SharedGroupAdapter;

public class GroupSharedActivity extends AppCompatActivity {

    private Toolbar mToolbar;
    private ViewPager mViewPager;
    private SharedGroupAdapter mPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new SharedGroupAdapter(getSupportFragmentManager(), this);
