...
import marcelin.thierry.chatapp.adapters.SharedPageAdapter;
...
public class SharedActivity extends AppCompatActivity {
    ...
    private SharedPageAdapter mPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nameStored = Users.getLocalContactList().get(mChatName);

        nameStored = nameStored != null && nameStored.length() > 0 ? nameStored :
                mChatName;

        Objects.requireNonNull(getSupportActionBar()).setTitle(nameStored);

        mViewPager = findViewById(R.id.tabPager);
        mPagerAdapter = new SharedPageAdapter(getSupportFragmentManager(), this);
