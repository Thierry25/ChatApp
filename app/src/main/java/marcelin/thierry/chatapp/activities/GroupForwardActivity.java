...
import marcelin.thierry.chatapp.adapters.ForwardLinkGroupAdapter;
import marcelin.thierry.chatapp.classes.Users;

public class GroupForwardActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    private ForwardLinkGroupAdapter mForwardLinkAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForwardLinkAdapter = new ForwardLinkGroupAdapter(mContactsFromFirebase);
